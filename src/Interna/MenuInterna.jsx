...
export default function MenuInterna({ tipoBusqueda, colision, numClaves, numCifras }) {
    ...
    if (tipoBusqueda == 1) {
        ...
        setNumInsertadas={setNumInsertadas} ordenInsercion={ordenInsercion} setOrdenInsercion={setOrdenInsercion} />
    } else if (colision == 2) {
        estructuraHash = <ColisionCuadratica 
        claves={claves} 
        setClaves={setClaves} 
        numCifras={numCifras} 
        numClaves={numClaves} 
        ...
        estructuraHash = <ColisionDobleHash 
        claves={claves} 
        setClaves={setClaves} 
        numCifras={numCifras} 
        numClaves={numClaves} 
        ...
        estructuraHash = <ColisionArregloAnidado 
        claves={claves} 
        setClaves={setClaves} 
        numCifras={numCifras} 
        numClaves={numClaves} 
        ...
        estructuraHash = <ColisionListaEnlazada 
        claves={claves} 
        setClaves={setClaves} 
        numCifras={numCifras} 
        numClaves={numClaves} 
